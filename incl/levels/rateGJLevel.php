...
if ($levelID < 100 || $rating < 1){exit("-1");}
...
// Add the vote
$query = $db->prepare("INSERT INTO `actions` (`ID`, `type`, `value`, `timestamp`, `value2`, `value3`, `value4`, `value5`, `value6`, `account`, `accIP`) VALUES (NULL, '21', '$levelID', '$timestamp', '$diff', '0', '0', '0', '0', '0', '$ip')");
$query->execute();
...
if ($result2['diffOverride'] == 0 && $count >= 2) {
